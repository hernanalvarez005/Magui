...
// Calca la estructura real de /stock: título+acciones, 4 tarjetas de KPI
// (stock total, sin stock, bajo mínimo, sucursales), filtros, tabla de
// saldos y la tarjeta de disponibilidad de kits.
